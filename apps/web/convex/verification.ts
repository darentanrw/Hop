    ...
    if (apiKey) {
      ...
      const { error } = await resend.emails.send({
        ...
        html: [
          ...
          "<p><strong>Reply with ONLY the passphrase above — nothing else.</strong> No other text, signature, or attachments.</p>",
          "<p>Your reply will confirm your identity and we'll use the name from your email signature for your profile.</p>",
