...
/**
 * Suspension model: suspension only prevents creating *new* ride windows.
 * If a user is already mid-flow (open availability, matched, in a group at
 * any lifecycle stage), they are allowed to continue through to completion.
 * Suspension takes effect the next time they try to schedule a ride.
 */
